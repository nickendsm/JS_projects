//
//
// Одномерная механическая модель кристаллической решетки, продольные колебания атомов
// Подробнее: http://tm.spbstu.ru/Одномерная_цепочка_Гука
// Версия от 25 августа 2022 года
//
//
//
			...
			var Q = [];
				...
				while (cnt != 25) { 
					...
					for (var io = parseInt(10*q + 25*(q-1)); io<=parseInt(10*q + 25*q); io++) {
						partcls[io].u += 0.4*(Math.cos(2*Math.PI/25*(io-parseInt(10*q + 25*(q-1))))-1);
						}
					}
				}
				cnt = 0;
				...
				while (cnt != 8) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 80*(q-1)); io<=parseInt(10*q + 80*q); io++) {
							partcls[io].u += 0.9*(Math.cos(2*Math.PI/20*(io-parseInt(10*q + 20*(q-1))))-1);
				...
				while (cnt != 24) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 15*(q-1)); io<=parseInt(10*q + 15*q); io++) {
							partcls[io].u += 0.25*(Math.cos(2*Math.PI/15*(io-parseInt(10*q + 15*(q-1))))-1);
				...
				while (cnt != 13) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 44*(q-1)); io<=parseInt(10*q + 44*q); io++) {
							partcls[io].u += 0.5*(Math.cos(2*Math.PI/11*(io-parseInt(10*q + 11*(q-1))))-1);
						}
					}
				}
				cnt = 0;
				...
				while (cnt != 26) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 19*(q-1)); io<=parseInt(10*q + 19*q); io++) {
							partcls[io].u += 0.3*(Math.cos(2*Math.PI/19*(io-parseInt(10*q + 19*(q-1))))-1);
						}
					}
				}
				cnt = 0;
				...
				while (cnt != 20) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 27*(q-1)); io<=parseInt(10*q + 27*q); io++) {
							partcls[io].u += 0.42*(Math.cos(2*Math.PI/27*(io-parseInt(10*q + 27*(q-1))))-1);
						}
					}
				}
				cnt = 0;
				...
				while (cnt != 26) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 29*(q-1)); io<=parseInt(10*q + 29*q); io++) {
							partcls[io].u += 0.41*(Math.cos(2*Math.PI/29*(io-parseInt(10*q + 29*(q-1))))-1);
						}
					}
				}
				// СПРАВА
				...
				while (cnt != 10) { 
					...
					for (var io = parseInt(10*q + 68*(q-1) + N/2); io<=parseInt(10*q + 68*q + N/2); io++) {
						partcls[io].u += 0.4*(Math.cos(2*Math.PI/34*(io-parseInt(10*q + 34*(q-1) + N/2)))-1);
						}
					}
				}
				cnt = 0;
				...
				while (cnt != 8) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 90*(q-1) + N/2); io<=parseInt(10*q + 90*q + N/2); io++) {
							partcls[io].u += 1*(Math.cos(2*Math.PI/90*(io-parseInt(10*q + 90*(q-1) + N/2)))-1);
				...
				while (cnt != 25) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 18*(q-1) + N/2); io<=parseInt(10*q + 18*q + N/2); io++) {
							partcls[io].u += 0.92*(Math.cos(2*Math.PI/18*(io-parseInt(10*q + 18*(q-1) + N/2)))-1);
				...
				while (cnt != 13) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 55*(q-1) + N/2); io<=parseInt(10*q + 55*q + N/2); io++) {
							partcls[io].u += 1.12*(Math.cos(2*Math.PI/55*(io-parseInt(10*q + 55*(q-1) + N/2)))-1);
				...
				while (cnt != 20) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 21*(q-1) + N/2); io<=parseInt(10*q + 21*q + N/2); io++) {
							partcls[io].u += 1.2*(Math.cos(2*Math.PI/21*(io-parseInt(10*q + 21*(q-1) + N/2)))-1);
						}
					}
				}
				cnt = 0;
				...
				while (cnt != 13) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 40*(q-1) + N/2); io<=parseInt(10*q + 40*q + N/2); io++) {
							partcls[io].u += 0.9*(Math.cos(2*Math.PI/40*(io-parseInt(10*q + 40*(q-1) + N/2)))-1);
						}
					}
				}
				cnt = 0;
				...
				while (cnt != 8) { 
					...
					if (Q.indexOf(q) == -1) { 
						...
						for (var io = parseInt(10*q + 76*(q-1) + N/2); io<=parseInt(10*q + 76*q + N/2); io++) {
							partcls[io].u += 0.9*(Math.cos(2*Math.PI/19*(io-parseInt(10*q + 19*(q-1) + N/2)))-1);
						}
					}
				}
